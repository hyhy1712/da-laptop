    ...
    <div class="container">
        <div class="breadcrumb">
            <ul class="d-flex align-items-center">
                ...
                <li class="active"><a href="{{$url_canonical}}">{{ trans('home.producttt') }}</a></li>
            </ul>
        </div>
    </div>
    <!-- Container End -->
                    ...
                    <div class="tab-content fix">
                        <div id="grid-view" class="tab-pane fade show active">
                            <div class="row">
                                ...
                                {{number_format($all_pro->unit_price,0,',','.')}} VNĐ
                                @else
                                {{number_format($all_pro->promotion_price,0,',','.')}} VNĐ
                                @endif" >
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="single-product">
                                        <!-- Product Image Start -->
                                        <div class="pro-img">
                                            <a id="wishList_producturl{{$all_pro->id}}" href="{{route('chitietsanpham',['id'=> $all_pro->id, 'product_slug'=>$all_pro->product_slug])}}">
                                                <img id="wishList_image{{$all_pro->id}}" class="primary-img" src="source/image/product/{{$all_pro->image}}" alt="single-product" height="268px" width="268px">
                                        ...
                                        <div class="pro-content">
                                            ...
                                            <div class="pro-actions">
                                                ...
                                                <div class="actions-secondary">
                                                    ...
                                                    <a style="cursor: pointer;" id="{{$all_pro->id}}" onclick="add_wishList(this.id)" title="{{ trans('home.addwishlist') }}"><i class="lnr lnr-heart"></i> <span>{{ trans('home.addwishlist') }}</span></a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Product Content End -->
                            ...
                            <div class="single-product">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-5 col-sm-12">
                                        <div class="pro-img">
                                            <a id="wishList_producturl{{$all_pro->id}}" href="{{route('chitietsanpham',['id'=> $all_pro->id, 'product_slug'=>$all_pro->product_slug])}}">
                                                <img id="wishList_image{{$all_pro->id}}" class="primary-img" src="source/image/product/{{$all_pro->image}}" alt="single-product" height="270px" width="270px">
                                        ...
                                        <div class="pro-content hot-product2">
                                            ...
                                            <div class="pro-actions">
                                                ...
                                                <div class="actions-secondary">
                                                    ...
                                                    <a style="cursor: pointer;" id="{{$all_pro->id}}" onclick="add_wishList(this.id)" title="" data-original-title="{{ trans('home.addwishlist') }}"><i class="lnr lnr-heart"></i> <span>{{ trans('home.addwishlist') }}</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
